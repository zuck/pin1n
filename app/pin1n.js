...
/**
 * Convert hanzi from traditional to simplified or viceversa.
 *
 * Credits to @hustlzip at:
 * https://github.com/hustlzp/jquery-s2t/blob/master/jquery.s2t.js
 */
function _tranStr(str, toT) {
  var i;
  var letter;
  var code;
  var index;
...
function _s2t(str) {
  return _tranStr(str, true);
}

function _t2s(str) {
  return _tranStr(str, false);
}
  ...
  var output = input
    ...
    .map(function(line) {
      return line
        ...
        .map(function(token) {
          return segment
            .doSegment(_t2s(token), { simple: true })
            .map(function(word) {
